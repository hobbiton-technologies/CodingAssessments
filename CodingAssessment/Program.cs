...
//dont show this in swagger documentation


app.MapGet("seed", async (PostgresDbContext db) =>
{
    if (await db.Packages.AnyAsync() && await db.Users.AnyAsync() && await db.Transactions.AnyAsync() && await db.Benefits.AnyAsync())
    {
